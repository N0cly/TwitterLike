...
$_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Stocker le code de réinitialisation dans la base de données (vous devez implémenter cette étape)
    $query = "INSERT INTO users (codeMDPOublie) VALUES ($code)";
    $stmt = $db->prepare($query);
    ...
    $headers = "From: thibaultamettler@gmail.com";
